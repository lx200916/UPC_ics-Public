...
def main():
    ...
    info += "Teacher: " + str(_colOfteacherName) + "列\n"
    print(info)
    ...
    while i < numOfRow:
        index = i - 1
        if str(table.cell(i, _colOfClassName).value) == u'' :
            i += 1
            continue
        ...
        teacherList.append(str(((table.cell(i, _colOfteacherName).value))))
        i += 1
    i = 0
    itemHeadStr = '{\n'
    itemTailStr = '\n}'
    ...
    for className in classNameList:
        ...
        itemClassInfoStr += '"teacher":"' + teacherList[i] + '"\n'
